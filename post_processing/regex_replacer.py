...
def main():
    ...
    # Apply all regex substitutions sequentially
    for pattern, replacement in replacements.items():
        # Using re.IGNORECASE dynamically could be added here if needed, 
        # but strict regex matching allows for case-sensitive corrections (e.g. API -> api)
