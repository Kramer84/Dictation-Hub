...
class BasePipeline:
    ...
    def call_llm(
        ...
        if schema:
            target_temperature = (
                0.0  # SOT Sec 5: Force deterministic output for structures
            )
        ...
        result = provider.generate(
            messages=messages, config=LLMConfig(temperature=target_temperature, keep_alive="1m"), response_schema=schema
        )
